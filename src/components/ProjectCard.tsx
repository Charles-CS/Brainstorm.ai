        ...
        <div className="relative p-8 flex flex-col h-full">
          ...
          <div className={`mt-auto pt-6 border-t ${isDark ? 'border-white/10' : 'border-zinc-100'}`}>
            ...
            <div className="space-y-3">
              ...
              <div className="text-[10px] text-indigo-500 font-bold flex items-center gap-1 mt-2 group-hover:underline">
                View full blueprint details <ArrowRight className="w-3 h-3" />
              </div>
            </div>
          </div>
        </div>
