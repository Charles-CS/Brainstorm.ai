        ...
        <div className="w-full max-w-[440px] relative">
          ...
          <div className={`relative p-6 md:p-8 rounded-[2rem] border backdrop-blur-2xl transition-all duration-500 ${isDark ? 'bg-white/5 border-white/10 shadow-2xl' : 'bg-white border-zinc-200 shadow-xl'}`}>
            ...
            <form className={isLogin ? "space-y-4" : "space-y-3"} onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full mt-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 rounded-2xl transition-all shadow-lg shadow-indigo-500/25 active:scale-[0.98]">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className={`flex items-center justify-center gap-2 py-2.5 rounded-2xl border transition-all ${isDark ? 'bg-white/5 border-white/10 hover:bg-white/10' : 'bg-zinc-50 border-zinc-200 hover:bg-zinc-100'}`}>
